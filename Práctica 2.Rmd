...
<span style="color:red"> *SERGIO, completar para dataframe de casos covid*</span>
...
<span style="color:red"> *SERGIO, completar, similar a práctica 1?*</span>
...
<span style="color:red"> *SERGIO, añadir para dataframes correspondientes, misma conclusión, no tendremos elementos vacíos*</span>
...
Vemos como los dataframes no contienen en ningún caso elementos vacíos --> debido a como se ha podido extraer la información de los entornos web.
...
<span style="color:red"> *SERGIO, completar para dataframes correspondientes, misma conclusión, no habrá valores extremos*</span>

# Análisis de los datos

## Selección de los grupos de datos

Para la evaluación de los dataset con el registro de demanda energética, estaremos interesados en mostrar una comparavia de la evolución de dicha demanda a fin de identificar varaciaciones significativas entre 2020 y 2019. 
