...
En esta segunda práctica, para las tareas de pre-postprocesado de datos y posterior análisis de conclusiones se ha optado por desarrollar un código en R, con la presentación del informe en RStudio.
